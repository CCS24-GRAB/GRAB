...
parser = ArgumentParser(description='bert_tiny_attack')
parser.add_argument('--device', default="cuda:0", type=str, help='cuda device')
parser.add_argument('--model', default="huawei-noah/TinyBERT_General_6L_768D", type=str, help='large language model')
...
RESULT_FILE = f"../results/ablation/models/tiny/hard_no_DL/{args.dataset}_bert_tiny_attack_hard_simreg_{args.run}_run_{BATCH_SIZE}.txt"
