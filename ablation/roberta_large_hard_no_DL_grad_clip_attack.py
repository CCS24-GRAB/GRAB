...
parser.add_argument('--model', default="roberta-large", type=str, help='large language model')
...
RESULT_FILE = f"../results/ablation/models/{args.model}/hard_no_DL/grad_clip/{args.dataset}_roberta_base_attack_hard_simreg_{args.run}_run_{BATCH_SIZE}.txt"
