...
RESULT_FILE = f"../results/ablation/dropout/{args.dropout}/hard_no_DL/{args.dataset}_bert_attack_hard_simreg_faster_{args.run}_run_{BATCH_SIZE}.txt"
PARALLEL = args.parallel
RECOVER_BATCH = args.recover_batch
lr_decay_type = args.lr_decay_type
print("Doing parallel: ", PARALLEL)

server = BertForSequenceClassification.from_pretrained(args.model, attention_probs_dropout_prob=dropout,
