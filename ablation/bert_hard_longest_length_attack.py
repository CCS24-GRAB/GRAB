...
RESULT_FILE = f"../results/ablation/longest_length/{args.dataset}_bert_attack_hard_simreg_faster_{args.run}_run_{BATCH_SIZE}.txt"
...
for training_batch in train_loop:
    ...
    for i in range(5):
        ...
        # TODO: The attention masks in continuous optimization might be a problem, should look at the performance first
        ...
        discrete_optimizer_separate = BeamSearchOptimizerIndividualLongest(copy.deepcopy(server), tokenizer, DEVICE,
                                                                    sequence_length,
