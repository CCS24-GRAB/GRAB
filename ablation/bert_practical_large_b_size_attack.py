...
RESULT_FILE = f"../results/ablation/large_b_size/{args.model}_{args.run}_run_b_{BATCH_SIZE}.txt"
...
data_file = f"../data/{args.dataset}_data_{BATCH_SIZE}.txt"
...
for batch_sequences, batch_labels in train_loop:
    ...
    for i in range(5):
        ...
        continuous_optimizer = ContinuousOptimizerIndividual(copy.deepcopy(discrete_solution), copy.deepcopy(server),
                                                             ...
                                                             seq_len=sequence_length, init_size=100, num_perm=100,
