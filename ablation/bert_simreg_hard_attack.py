...
parser.add_argument("--simreg", default=100, type=int, help="similarity regularization weight")
...
RESULT_FILE = f"../results/ablation/simreg/b{BATCH_SIZE}/{args.dataset}_bert_attack_hard_simreg_faster_{args.run}_run_{BATCH_SIZE}.txt"
...
for training_batch in train_loop:
    ...
    for i in range(5):
        ...
        continuous_optimizer = ContinuousOptimizerIndividual(copy.deepcopy(discrete_solution), copy.deepcopy(server),
                                                             ...
                                                             lr=lr, lr_decay_type=lr_decay_type, simreg=simreg,
