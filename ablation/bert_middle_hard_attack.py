...
epochs = args.epochs
RESULT_FILE = f"../results/ablation/models/middle/epoch_{epochs}/lamp_full_frozen/{args.dataset}_bert_attack_hard_simreg_faster_{args.run}_run_{BATCH_SIZE}.txt"
PARALLEL = args.parallel
RECOVER_BATCH = args.recover_batch
lr_decay_type = args.lr_decay_type
print("Doing parallel: ", PARALLEL)

server = BertForSequenceClassification.from_pretrained(f"../models/lamp_epoch_{epochs}_frozen").to(DEVICE)
