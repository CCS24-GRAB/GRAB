...
RESULT_FILE = f"../results/ablation/label/{args.dataset}_bert_attack_hard_simreg_faster_{args.run}_run_{BATCH_SIZE}.txt"
...
for training_batch in train_loop:
    ...
    for i in range(5):
        ...
        discrete_optimizer_separate = BeamSearchOptimizerIndividualLabel(copy.deepcopy(server), tokenizer, DEVICE,
                                                                    sequence_length,
