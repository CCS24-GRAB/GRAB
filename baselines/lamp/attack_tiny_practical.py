...
def main():
    ...
    for i in range(args.n_inputs):
        ...
        if args.baseline:
            result_file = f"results/bert_tiny/{args.loss}/{args.dataset}/{args.bert_path}_{args.run}_run_{args.batch_size}_results.txt"
        else:
            if args.loss == "tag":
                result_file = f"results/bert_tiny/lamp_l1l2/{args.dataset}/{args.bert_path}_{args.run}_run_{args.batch_size}_results.txt"
            else:
                result_file = f"results/bert_tiny/lamp_{args.loss}/{args.dataset}/{args.bert_path}_{args.run}_run_{args.batch_size}_results.txt"
