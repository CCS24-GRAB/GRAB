...
def main():
    ...
    for i in range(args.n_inputs):
        ...
        if args.baseline:
            result_file = f"results/noise/{args.defense_noise}/{args.loss}_hard/{args.dataset}_{args.run}_run_{args.batch_size}_results.txt"
        else:
            if args.loss == "tag":
                result_file = f"results/noise/{args.defense_noise}/lamp_l1l2_hard/{args.dataset}_{args.run}_run_{args.batch_size}_results.txt"
            else:
                result_file = f"results/noise/{args.defense_noise}/lamp_{args.loss}_hard/{args.dataset}_{args.run}_run_{args.batch_size}_results.txt"
