...
parser.add_argument('--prune', default=0.75, type=float, help="gradient pruning percentage")
...
prune = args.prune
RESULT_FILE = f"../results/defense/prune/{prune}/no_DL_PM/{args.run}_run_b_{BATCH_SIZE}.txt"
