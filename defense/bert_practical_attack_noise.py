...
parser.add_argument('--noise', default=0.001, type=float, help="defense noise level")
...
noise = args.noise
RESULT_FILE = f"../results/defense/noise/{noise}/DL_NN/{args.run}_run_b_{BATCH_SIZE}.txt"
