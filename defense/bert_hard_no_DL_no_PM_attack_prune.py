...
prune = args.prune
RESULT_FILE = f"../results/defense/prune/{prune}/hard_no_DL_no_PM/{args.dataset}_bert_attack_hard_simreg_{args.run}_run_{BATCH_SIZE}.txt"
...
for training_batch in train_loop:
    ...
    for i in range(5):
        ...
        continuous_optimizer = ContinuousOptimizerIndividual(copy.deepcopy(discrete_solution),
