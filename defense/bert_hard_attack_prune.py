...
prune = args.prune
RESULT_FILE = f"../results/defense/prune/{prune}/{args.dataset}_bert_attack_hard_simreg_{args.run}_run_{BATCH_SIZE}.txt"
print("Gradient pruning: ", bool(prune))
...
for training_batch in train_loop:
    ...
    if prune is None:
        ...
        loss, attentions, hidden_states, logits = train_batch_with_frozen_weights_and_prune(client, training_batch,
                                                                                            DEVICE, prune)
